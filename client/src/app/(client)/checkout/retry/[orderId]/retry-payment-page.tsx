...
import { useRetryCheckout } from '@/components/client/user/account/desktop/orders/use-retry-checkout'
import { QrSepay } from '@/components/client/checkout/payment/qr-sepay'
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 max-w-md mx-auto">
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-gray-600 text-center">??n h?ng</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="container mx-auto px-4 max-w-2xl py-8">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-lg">??n h?ng</p>
          </div>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between py-3 border-b border-gray-100">
                ...
                <span className="font-bold text-2xl text-red-600">
                  {order.totalPayment.toLocaleString()}??n h?ng
                </span>
              </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left flex-1">
                  ...
                  <div className="text-gray-600 mb-2">??n h?ng</div>
        ...
        <div className="mt-6 bg-green-50 border border-green-200 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-700">??n h?ng</p>
            </div>
          </div>
        </div>
      </div>
