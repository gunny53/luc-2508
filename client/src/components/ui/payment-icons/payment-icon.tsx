...
export function PaymentIcon({ type, className, size = 40 }: PaymentIconProps) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={cn(className)}>
      {config.colors?.background && <rect x="-4" y="-4" width="24" height="24" fill={config.colors.background} />}
