          ...
          <CommandList>
            ...
            <CommandGroup>
              {brands.map((brand) => (
                ...
                >
                  <Check className={cn('mr-2 h-4 w-4', selectedValue === brand.value ? 'opacity-100' : 'opacity-0')} />
                  <div className="flex items-center">
                    {brand.image && (
                      <img src={brand.image} alt={brand.label} className="h-5 w-5 mr-2 rounded-full object-contain" />
                    )}
