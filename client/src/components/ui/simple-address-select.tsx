          ...
          >
            ...
            <SelectContent>
              {provinces?.data?.map((province) => (
                <SelectItem key={province.ProvinceID} value={province.ProvinceID.toString()} className="text-sm">
          ...
          >
            ...
            <SelectContent>
              {districts?.data?.map((district) => (
                <SelectItem key={district.DistrictID} value={district.DistrictID.toString()} className="text-sm">
