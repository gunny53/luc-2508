    ...
    if (isOpen) {
      ...
      const id = toast(
        <div className="flex flex-col gap-2 p-2 w-full">
          <div className="text-base font-semibold text-black">English content normalized from the original source text.</div>
          <div className="text-sm text-gray-500 leading-snug">English content normalized from the original source text.</div>
          <div className="flex justify-end gap-2 mt-2">            <Button
            ...
            >English content normalized from the original source text.</Button><Button
              size="sm"
            ...
            >
              {loading ? (
                <span className="flex items-center">
                  ...
                  </svg>English content normalized from the original source text.</span>
