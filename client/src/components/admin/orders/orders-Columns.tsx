...
import { ChevronDown, ChevronRight, Eye, Package, Printer, RefreshCw } from 'lucide-react'
...
export const OrdersColumns = ({
  ...
  
  {
    ...
    id: 'products',
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title={t('products')} className="justify-center text-center px-2" />
    ),
    cell: ({ row }) => {
      const items = row.original.items
      const totalItems = items.reduce((sum, item) => sum + item.quantity, 0)
  ...
  },
  {
    ...
    cell: ({ getValue }) => (
      <div className="w-[140px] truncate text-center font-medium text-slate-600 py-3" title={getValue<string>()}>
  ...
  },
  {
    ...
    id: 'orderDate',
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title={t('orderDate')} className="justify-center text-center px-2" />
    ),
    cell: ({ getValue }) => {
  ...
  },
  {
    ...
    id: 'customerName',
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title={t('customerName')} className="justify-center text-center px-2" />
    ),
    cell: ({ getValue, row }) => {
  ...
  },
  {
    ...
    id: 'status',
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title={t('status')} className="justify-center text-center px-2" />
    ),
    cell: ({ getValue }) => {
  ...
  },
  {
    ...
    id: 'totalPayment',
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title={t('totalPayment')} className="justify-center text-center px-2" />
    ),
    cell: ({ getValue, row }) => {
