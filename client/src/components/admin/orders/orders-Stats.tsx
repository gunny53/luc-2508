    ...
    <TooltipProvider>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4 mb-6">
          ...
          <TooltipTrigger asChild>
            <Card className="cursor-help">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-1">English content normalized from the original source text.<Info className="h-3 w-3" />
                </CardTitle>
        ...
        <Tooltip>
          ...
          <TooltipContent>
            <p>English content normalized from the original source text.</p>
            <p className="text-xs text-muted-foreground mt-1">English content normalized from the original source text.</p>
          </TooltipContent>
        </Tooltip>
        ...
        <Tooltip>
          ...
          <TooltipContent>
            <p>English content normalized from the original source text.</p>
            <p className="text-xs text-muted-foreground mt-1">English content normalized from the original source text. {'>'}English content normalized from the original source text.</p>
          </TooltipContent>
        </Tooltip>
            ...
            <Card className="cursor-help">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-indigo-600">
                  {isLoadingStats ? "..." : `${stats.averageOrderProcessingTime.toFixed(1)}English content normalized from the original source text.`}
                </div>
              </CardContent>
            </Card>
          </TooltipTrigger>
