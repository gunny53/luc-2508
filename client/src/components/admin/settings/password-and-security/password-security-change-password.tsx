...
import { usePasswordSecurityChangePassword } from './use-password-security-change-password'
...
export const ChangePasswordModal = ({ open, onOpenChange }: ChangePasswordModalProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold">{t('admin.profileSettings.changePassword.title')}</DialogTitle>
        </DialogHeader>
        <div className="py-4">
          <div className="mb-6">
          ...
          <div className="flex items-center p-3 mb-4 space-x-2 text-sm text-blue-800 rounded-lg bg-blue-50">
            ...
            <p className="text-sm text-blue-600">{t('admin.profileSettings.changePassword.passwordPolicy')}</p>
          </div>
          ...
          <Form {...form}>
            ...
            >
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('admin.profileSettings.changePassword.currentPassword')}</FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('admin.profileSettings.changePassword.newPassword')}</FormLabel>
                    <FormControl>
                      <div className="relative">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('admin.profileSettings.changePassword.confirmNewPassword')}</FormLabel>
                    <FormControl>
                      <div className="relative">
