...
import { useEditVoucher } from '../hook/use-edit-voucher'
import { Discount } from '@/types/discount.interface'
import VoucherBasicInfo from '../new/new-basic-info'
import VoucherDiscountSettings from '../new/new-settings-voucher'
import VoucherShowSettings from '../new/new-show-voucher'
...
export function VoucherEditIndex({ voucher, userData, onEditSuccess }: VoucherEditIndexProps) {
  ...
  const { formData, updateFormData, errors, voucherType, useCase, isEdit, submitVoucher, resetForm, isLoading } =
    useEditVoucher({
      voucher,
      userData,
      onEditSuccess:
