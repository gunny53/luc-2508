...
const VoucherEditDynamic = dynamic(() => import('./edit-index').then((mod) => ({ default: mod.VoucherEditIndex })), {
  ssr: false
})

export default function VoucherEditWrapper({ voucher, userData, onEditSuccess }: VoucherEditWrapperProps) {
  return <VoucherEditDynamic voucher={voucher} userData={userData} onEditSuccess={onEditSuccess} />
}
