...
export default function VoucherBasicInfo({
  formData,
  updateFormData,
  errors,
  useCase,
  ...
  const getTimeValue = (dateTimeString: string, type: 'hour' | 'minute') => {
    ...
    return type === 'hour' ? date.getHours().toString().padStart(2, '0') : date.getMinutes().toString().padStart(2, '0')
  }
      ...
      <CardHeader className="pb-6 border-b border-gray-100">
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          {[
            ...
            <div className="px-2 py-1 bg-red-100 text-red-700 text-xs rounded-full font-medium">Admin Only</div>
          )}
        </div>
      </CardHeader>
