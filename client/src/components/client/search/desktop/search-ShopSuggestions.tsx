export default function ShopSuggestion() {
  return (
    <div className="bg-white p-4 border rounded shadow-sm">
      <h2 className="text-sm font-semibold text-gray-700 mb-2">English content normalized from the original source text.</h2>
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-gray-200 rounded-full" />
          <div>
            <div className="font-semibold text-sm">English content normalized from the original source text.</div>
