        ...
        <DrawerContent>
          <div className="h-[100vh] mx-auto w-full max-w-sm">
            <DrawerHeader className="relative">
              ...
              <div className="text-gray-600 mt-2">{t('admin.profileSettings.regenerateCodesDescription')}</div>
            </DrawerHeader>
    ...
    return (
      <Drawer open={open} onOpenChange={onOpenChange}>
        <DrawerContent>
          <div className="h-[100vh] mx-auto w-full max-w-sm">
            <DrawerHeader className="relative">
              <DrawerTitle className="text-xl font-semibold">{t('admin.profileSettings.QrCode.title2fa')}</DrawerTitle>
              <button
            ...
            <div className="p-4 space-y-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-sm">{t('admin.profileSettings.QrCode.downloadAuth')}</div>
                  <div className="text-gray-600 text-xs">
                    <Link href="https://authy.com/" target="_blank" className="text-red-600 hover:underline">
                      Authy
                    </Link>{' '}
    ...
    return (
      <Drawer open={open} onOpenChange={onOpenChange}>
        <DrawerContent>
          <div className="h-[100vh] mx-auto w-full max-w-sm">
            <DrawerHeader className="relative">
              <DrawerTitle className="text-xl font-semibold">{t('admin.profileSettings.QrCode.title')}</DrawerTitle>
              <button
              ...
              <p className="text-sm text-gray-600 mt-2">{t('admin.profileSettings.QrCode.description')}</p>
            </DrawerHeader>
            ...
            <DrawerFooter className="border-t">
              <Button className="w-full bg-red-600 text-white" onClick={() => setShowRecoveryCodesDialog(false)}>
