...
import { useUpdateProfile } from './../../profile/use-profile-update'
      ...
      <DrawerContent>
        <div className="h-[100vh] mx-auto w-full max-w-sm">
          <DrawerHeader className="relative">
            <DrawerTitle className="text-xl font-semibold">{t('user.account.profile.title')}</DrawerTitle>
            <button
          ...
          <div className="p-4 space-y-6">
              ...
              <div className="relative cursor-pointer group" onClick={handleAvatarClick}>
                {avatar ? (
                  ...
                  <div className="w-24 h-24 rounded-full bg-gray-200 flex items-center justify-center">
                    <span className="text-3xl font-semibold text-gray-600">{avatarText}</span>
                  </div>
                )}
                <label
            ...
            <form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <div>
                ...
                <Input id="phoneNumber" {...form.register('phoneNumber')} type="tel" className="w-full" />
              </div>

              <Button className="bg-red-600 text-white w-full mt-4" type="submit" disabled={loading}>
