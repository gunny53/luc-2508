    ...
    <>
      ...
      <div
        className={cn(
          ...
          open ? 'opacity-50 visible z-40' : 'opacity-0 invisible'
        )}
        aria-hidden="true"
      />
      <div ref={containerRef} className="relative z-50 category-hover-container">
        ...
        <div className="relative" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
          <motion.div
            ...
            animate={{
              backgroundColor: open ? 'rgba(233, 233, 233, 0.4)' : 'rgba(233, 233, 233, 0)',
              boxShadow: open ? '0 10px 15px -3px rgba(0, 0, 0, 0.08), 0 4px 6px -2px rgba(0, 0, 0, 0.05)' : 'none',
              scaleX: open ? 1 : 0.5,
              scaleY: open ? 1 : 0.8
            }}
            whileHover={{
