...
import MobileCartItem from './cart-items-mobile'
import MobileCartHeader from './cart-header-mobile'
import MobileCartFooter from './cart-footer-mobile'
...
export default function MobileCartIndex() {
  const { shopCarts, isLoading, updateCartItemAndRefresh, removeItems } = useCart()
              ...
              <div key={shop.shop.id} className="bg-white mb-2 shadow-sm">
                <div className="p-4 border-b flex items-center gap-3">
                  <Checkbox
                    ...
                    onCheckedChange={() => handleToggleShop(shop.shop.id, shop.cartItems)}
                  />
                ...
                <div>
                  {shop.cartItems.map((item: CartItem) => (
                    <MobileCartItem
                      ...
                      onToggle={() => handleToggleItem(shop.shop.id, item.id, shop.cartItems)}
