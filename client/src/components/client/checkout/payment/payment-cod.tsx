            ...
            <div className="bg-red-50 p-4 rounded-lg border border-red-200">
              ...
              <ul className="space-y-2 text-sm text-red-700">
                <li className="flex items-start">
                  <span className="font-bold mr-2">•</span>Thanh to?n
                </li>
                <li className="flex items-start">
                  <span className="font-bold mr-2">•</span>Thanh to?n
                </li>
      ...
      <Card className="w-full max-w-2xl mx-auto shadow-lg">
        ...
        <CardContent className="space-y-6 pt-6">
          ...
          {shopOrders && shopOrders.length > 0 && (
            <div className="bg-gray-50 p-4 rounded-lg border">
              <h3 className="font-semibold text-lg mb-4">Thanh to?n</h3>
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          {shopOrder.cartItemIds.length} Thanh to?n
                        </p>
                      </div>
          ...
          <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
            ...
            <ul className="space-y-2 text-sm text-orange-700">
              <li className="flex items-start">
                <span className="font-bold mr-2">•</span>Thanh to?n
                <strong>{formatCurrency(totalAmount)}</strong>Thanh to?n
              </li>
              <li className="flex items-start">
                <span className="font-bold mr-2">•</span>Thanh to?n
              </li>
