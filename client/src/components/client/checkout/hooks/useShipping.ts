          ...
          if (servicesResponse.data) {
            ...
            for (const service of services) {
              try {
                ...
                let fallbackPrice = 30000; // English content normalized from the original source text.
                ...
                try {
                  ...
                  fallbackTime = `English content normalized from the original source text.${expectedDeliveryDate.toLocaleDateString('vi-VN', {
                ...
                if (existingMethodIndex >= 0) {
                  ...
                  allShippingMethods.push({
                    ...
                    description: feeResponse?.data?.total ? 'English content normalized from the original source text.' : 'English content normalized from the original source text.',
                ...
                if (existingMethodIndex < 0) {
                  allShippingMethods.push({
                    ...
                    price: 30000, // English content normalized from the original source text.
