...
export const authService = {
  ...
  resetPassword: async (data: ResetPasswordRequest): Promise<ResetPasswordResponse> => {
    const response = await privateAxios.post<ResetPasswordResponse>(API_ENDPOINTS.AUTH.RESET_PASSWORD, data)
    return response.data
  },
  ...
  verify2fa: async (data: Verify2faRequest): Promise<Verify2faResponse> => {
    const response = await privateAxios.post<Verify2faResponse>(API_ENDPOINTS.AUTH.VERIFY_2FA, data)
    return response.data
  },
  sendOTP: async (data: SendOTPRequest): Promise<SendOTPResponse> => {
    const response = await privateAxios.post<SendOTPResponse>(API_ENDPOINTS.AUTH.SEND_OTP, data)
    return response.data
  },
  resendOTP: async (): Promise<SendOTPResponse> => {
    const response = await privateAxios.post<SendOTPResponse>(API_ENDPOINTS.AUTH.RESEND_OTP)
    return response.data
  },
  verifyOTP: async (data: VerifyOTPRequest): Promise<VerifyOTPResponse> => {
    const response = await privateAxios.post<VerifyOTPResponse>(API_ENDPOINTS.AUTH.VERIFY_OTP, data)
    return response.data
  },
  ...
  disable2fa: async (data: Disable2faRequest): Promise<Disable2faResponse> => {
    const response = await privateAxios.post<Disable2faResponse>(API_ENDPOINTS.AUTH.DISABLE_2FA, data)
    return response.data
  },

  confirm2fa: async (data: Confirm2faRequest): Promise<Confirm2faResponse> => {
    const response = await privateAxios.post<Confirm2faResponse>(API_ENDPOINTS.AUTH.CONFIRM_2FA, data)
    return response.data
  },
