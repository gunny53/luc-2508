...
class LanguagesService {
  ...
  async getById(id: string, signal?: AbortSignal): Promise<LangGetByIdResponse> {
    try {
      const response = await privateAxios.get(API_ENDPOINTS.LANGUAGES.GETBYID.replace(':id', id), { signal })
      return response.data
    } catch (error) {
      throw error
    }
  ...
  async create(data: LangCreateRequest, signal?: AbortSignal): Promise<LangCreateResponse> {
    try {
      const response = await privateAxios.post(API_ENDPOINTS.LANGUAGES.POST, data, { signal })
      return response.data
    } catch (error) {
      throw error
    }
  ...
  async update(id: string, data: LangUpdateRequest, signal?: AbortSignal): Promise<LangUpdateResponse> {
    try {
      const response = await privateAxios.put(API_ENDPOINTS.LANGUAGES.UPDATE.replace(':id', id), data, { signal })
      return response.data
    } catch (error) {
      throw error
    }
  ...
  async deleteById(id: string, signal?: AbortSignal): Promise<LangDeleteResponse> {
    try {
      const response = await privateAxios.delete(API_ENDPOINTS.LANGUAGES.DELETE_BY_ID.replace(':id', id), { signal })
      return response.data
    } catch (error) {
      throw error
    }
