...
import { CreateProductBodyType, GetManageProductsQueryType, UpdateProductBodyType } from '@routes/product/product.model'
...
import { CacheEvict } from '@shared/decorators/cacheable.decorator'
