      ...
      options: {
        ...
        domain:
          process.env.COOKIE_ACCESS_TOKEN_DOMAIN && process.env.COOKIE_ACCESS_TOKEN_DOMAIN !== '/'
            ...
            : undefined,
        maxAge: ms((process.env.AUTH_ACCESS_TOKEN_EXP || '1d') as ms.StringValue)
      }
    },
      ...
      options: {
        ...
        domain:
          process.env.COOKIE_REFRESH_TOKEN_DOMAIN && process.env.COOKIE_REFRESH_TOKEN_DOMAIN !== '/'
            ...
            : undefined,
        maxAge: ms((process.env.AUTH_REFRESH_TOKEN_EXP || '7d') as ms.StringValue)
      }
    },
      ...
      options: {
        ...
        domain:
          process.env.COOKIE_CSRF_TOKEN_DOMAIN && process.env.COOKIE_CSRF_TOKEN_DOMAIN !== '/'
            ...
            : undefined,
        maxAge: ms((process.env.COOKIE_CSRF_TOKEN_EXP || '1h') as ms.StringValue)
      }
    }
  })
)
