...
import { OrderShippingStatus, OrderShippingStatusType } from '@shared/constants/order-shipping.constants'
...
import { CreateOrderType, GHNWebhookPayloadType } from '@routes/shipping/ghn/shipping-ghn.model'
