...
async function importFullAddressesFromGHN(
  ...
  try {
    ...
    logger.log(
      `English content normalized from the original source text.${provinces.length}English content normalized from the original source text.`
    )
    ...
    logger.log(
      `English content normalized from the original source text.${realProvinces.length}English content normalized from the original source text.${provinces.length}English content normalized from the original source text.`
    )
      ...
      try {
        ...
        for (const district of selectedDistricts) {
          try {
            ...
            logger.warn(
              `English content normalized from the original source text.${district.DistrictName}: ${error.message}`
            )
          }
        }
        ...
        logger.warn(
          `English content normalized from the original source text.${province.ProvinceName}: ${error.message}`
        )
      }
    }

    logger.log(
      `English content normalized from the original source text.${allGhnAddresses.length}English content normalized from the original source text.${realProvinces.length}English content normalized from the original source text.`
    )
    ...
    logger.log(
      `English content normalized from the original source text.${addressesToCreate.length}English content normalized from the original source text.`
    )
    let addressCount = 0
    ...
    logger.log(
      `English content normalized from the original source text.${copyChunks.length}English content normalized from the original source text.`
    )
...
async function main() {
  ...
  try {
    ...
    logger.log(
      `English content normalized from the original source text.${deletedUserAddresses.count} user-address relationships`
    )
    logger.log('English content normalized from the original source text.')
    ...
    if (totalDefaultAddresses === totalUsers) {
      ...
      logger.warn(
        `English content normalized from the original source text.${totalUsers - totalDefaultAddresses}English content normalized from the original source text.`
      )
    }
